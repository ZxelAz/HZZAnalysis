#!/bin/bash
# BDT training entry-point.

: "${HZZ_ROOT:=/afs/cern.ch/work/z/zhiheng/Thesis/HZZAnalysis}"
DATA_DIR="/eos/user/z/zhiheng/STXS_samples"
TRIAL="${TRIAL:-trial53}"
OUTPUT_DIR="${HZZ_ROOT}/Categorisation/BDT/Models/${TRIAL}"
SCRIPT="${HZZ_ROOT}/Categorisation/BDT/RunScripts/train_multiclass_bdt_refactored.py"
...
python -u "${SCRIPT}" \
    ...
    --plot \
    --use-gpu \
    --GATO_data_path /eos/user/z/zhiheng/STXS_samples/GATOdata \
    --tune-hyperparameters 500

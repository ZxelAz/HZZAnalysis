...
def main():
    ...
    parser.add_argument('--mode', '-m', type=str, required=True, help='the mode of the input file')
...
int STXSStage12MergedCat(int cat) {
    if (cat == 102 || cat == 103 || cat == 104) return 101;
    if (cat == 114 || cat == 115 || cat == 116) return 113;
    if (cat == 201 || cat == 203 || cat == 205) return 202;
    if (cat == 210) return 208;
    if (cat == 302 || cat == 401 || cat == 402 || cat == 501 || cat == 502) return 301;
    if (cat == 304 || cat == 305 || cat == 403 || cat == 404 || cat == 405 || cat == 503 || cat == 504 || cat == 505) return 303;
    if (cat == 602 || cat == 603 || cat == 604 || cat == 605) return 601;
    return cat;
}
...
std::string STXSStage12Label(int cat, const std::string& mode) {
    ...
    switch (merged_cat) {
        ...
        case 100: label = "GG2H_FWDH"; break;
        case 101: label = "GG2H_PTH_GT200"; break;
        case 105: label = "GG2H_0J_PTH_0_10"; break;
        case 106: label = "GG2H_0J_PTH_GT10"; break;
        case 107: label = "GG2H_1J_PTH_0_60"; break;
        case 108: label = "GG2H_1J_PTH_60_120"; break;
        case 109: label = "GG2H_1J_PTH_120_200"; break;
        case 110: label = "GG2H_GE2J_MJJ_0_350_PTH_0_60"; break;
        case 111: label = "GG2H_GE2J_MJJ_0_350_PTH_60_120"; break;
        case 112: label = "GG2H_GE2J_MJJ_0_350_PTH_120_200"; break;
        case 113: label = "GG2H_GE2J_MJJ_GT350"; break;
        case 200: label = "QQ2HQQ_FWDH"; break;
        case 202: label = "QQ2HQQ_rest"; break;
        case 204: label = "QQ2HQQ_GE2J_MJJ_60_120"; break;
        case 206: label = "QQ2HQQ_GE2J_MJJ_GT350_PTH_GT200"; break;
        case 207: label = "QQ2HQQ_GE2J_MJJ_350_700_PTH_0_200_PTHJJ_0_25"; break;
        case 208: label = "QQ2HQQ_GE2J_MJJ_GT350_PTH_0_200_PTHJJ_GT25"; break;
        case 209: label = "QQ2HQQ_GE2J_MJJ_GT700_PTH_0_200_PTHJJ_0_25"; break;
        case 300: label = "QQ2HLNU_FWDH"; break;
        case 301: label = "VH_lep_PTV_0_150"; break;
        case 303: label = "VH_lep_PTV_GT150"; break;
        case 400: label = "QQ2HLL_FWDH"; break;
        case 500: label = "GG2HLL_FWDH"; break;
        case 600: label = "TTH_FWDH"; break;
        case 601: label = "TTH"; break;
...
''')
    ...
    # Define event weights and production mode
    
    genEventSumw = get_genEventSumw(file_path)
    new_rdf = new_rdf.Define("EventWeight_lumi18", f"18.063 * overallEventWeight * 1000 / {genEventSumw}") \
                     .Define("EventWeight_lumi138", f"138 * overallEventWeight * 1000 / {genEventSumw}") \
                     .Define("EventWeight_lumi9", f"9.693 * overallEventWeight * 1000 / {genEventSumw}") \
                     .Define("EventWeight_lumi62", f"62.34 * overallEventWeight * 1000 / {genEventSumw}") \
                     .Define("genEventSumw", f"{genEventSumw}") \
                     .Define("production_mode", f'std::string("{mode}")') \
                     .Define("trainWeight", "genWeight * puWeight") \
                     .Define("HTXS_stage1_2_cat_pTjet30GeV_label", "STXSStage12Label(HTXS_stage1_2_cat_pTjet30GeV, production_mode)") \
                     .Define("HTXS_stage1_2_cat_pTjet30GeV_merged", "STXSStage12MergedCat(HTXS_stage1_2_cat_pTjet30GeV)") \
    ...
    columns_to_save = [
        ...
        "EventWeight_lumi18", "EventWeight_lumi9", "EventWeight_lumi138", "EventWeight_lumi62", "production_mode", 
        "HTXS_stage_0", "overallEventWeight", "genWeight", "puWeight", "trainWeight", "HTXS_stage1_2_cat_pTjet30GeV", "HTXS_stage1_2_cat_pTjet30GeV_merged", "HTXS_stage1_2_cat_pTjet30GeV_label", "genEventSumw"
    ]
    
    # Snapshot is lazy - trigger execution
    snapshot_result = new_rdf.Snapshot("Events", f"{output_path}/{mode}.root", columns_to_save)
    print("Snapshot created.")
    # Force execution and get event count
    n_events = snapshot_result.Count().GetValue()
    print(f"Saved {n_events} events to {output_path}/{mode}.root")
